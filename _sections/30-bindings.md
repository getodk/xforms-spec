...
<a id="fn:decimal-time" href="#fn:decimal-time">`decimal-time(time value)`</a> | Converts time value to a number representing a fractional day. For example, noon is 0.5 and 6pm is 0.75.
