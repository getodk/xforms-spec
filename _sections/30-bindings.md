...
| `odk:quality` | Specifies a quality level to be used for binary datatype. This will only be used for audio prompts (where mediatype is `audio/*`). Quality levels are documented [here](#quality-levels).
